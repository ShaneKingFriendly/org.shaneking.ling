...
/**
 * https://github.com/Sheep-y/Base85
 */

/**
 * Example: <br>
 * <code> String encodedString = Base85a.getZ85Encoder().encodeToString( byteArray ); <br>
 * byte[] data = Base85a.getZ85Decoder().decodeToBytes( encodedString );</code>
 */
public class Base85a {
  ...
  private static Encoder ASCII85ENCODER, RFC1924ENCODER, Z85ENCODER;
  private static Decoder ASCII85DECODER, RFC1924DECODER, Z85DECODER;
